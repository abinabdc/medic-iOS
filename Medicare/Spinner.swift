...
//
//  Created by Deependra Dhakal on 7/13/20.
//  Copyright © 2020 TechnoSanta. All rights reserved.
//
...
final class Spinner {
     ...
     */
    public static func start(style: UIActivityIndicatorView.Style = Spinner.style,
        ...
        addConstraints(to: window, with: spinner)
